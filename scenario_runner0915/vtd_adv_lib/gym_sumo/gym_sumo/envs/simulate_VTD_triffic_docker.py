...
sys.path.insert(0,'/root/changan_adv_model_vtd_1-31/gym_sumo')
sys.path.insert(0,'/root/changan_adv_model_vtd_1-31')
...
class VTD_Manager:
    ...
    def faster_act(self,var = 1):
        ...
        if self.dis < self.safe_dis + 4 and  self.gl.ego.vx  > 2 :
            acceleration = 1.5
    ...
    def contrl_adv(self):
        ...
        # 横向控制指令
        # print("self.keep_time:",self.keep_time)
        # print("self.keep_time_index:",self.keep_time_index)
...
def make_args():
    ...
    args.add_argument('--adv_type', default=3, type = int) # scenario type
    # model = 3
    ...
    if adv_type == 4:
        ...
        args.add_argument('--load-model-id-ita', default="lanechange_ita", type=str) # exp4 400 407 exp5 417 455  370   
        args.add_argument('--load-model-id-ped', default="ped_lon", type=str) # 348    
    if adv_type == 5:
        # pedestrain  348
        args.add_argument('--load-model-id', default="ramp_lon", type=str) # 454  374
