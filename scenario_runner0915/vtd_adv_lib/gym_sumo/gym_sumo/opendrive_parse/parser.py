...
from gym_sumo.opendrive_parse.elements.opendrive import OpenDrive, Header
from gym_sumo.opendrive_parse.elements.road import Road
from gym_sumo.opendrive_parse.elements.roadLink import (
    Predecessor as RoadLinkPredecessor,
    Successor as RoadLinkSuccessor,
    Neighbor as RoadLinkNeighbor,
)
from gym_sumo.opendrive_parse.elements.roadtype import (
    RoadType,
    Speed as RoadTypeSpeed,
)
from gym_sumo.opendrive_parse.elements.roadElevationProfile import (
    ElevationRecord as RoadElevationProfile,
)
from gym_sumo.opendrive_parse.elements.roadLateralProfile import (
...
from gym_sumo.opendrive_parse.elements.roadLanes import (
...
from gym_sumo.opendrive_parse.elements.junction import (
    Junction,
...
if __name__ == '__main__':
    ...
    path = '/home/sx/wjc/wjc/datasets/Geely_hangzhou_bay_1.xodr'
