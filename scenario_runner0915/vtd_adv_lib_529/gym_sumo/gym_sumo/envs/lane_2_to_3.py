...
class Lane2To3Env(AbstractEnv):
    ...
    def default_config(cls) -> dict:
        ...
        cfg.update({
            ...
            'make_road': False,
            'map_file_path': '/home/sx/wjc/wjc/datasets/ca_vtd_train_data/lanechange/2_lane_to_3_Lane-0001.xodr',
        ...
        if self.config['AtomicScene'] == 'lon_mode':
            ...
            scenarios = {
                'scene_1': {
                    ...
                    'test_av_obj_road_info': (road_info[1], 0, -3)
                },
                'scene_2': {
                    'ego_road_info': (road_info[0], 0, -2),
