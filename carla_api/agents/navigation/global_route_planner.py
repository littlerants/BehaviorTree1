...
from carla_api.agents.tools.misc import vector
...
class GlobalRoutePlanner(object):
    ...
    def _build_graph(self):
        ...
        creating several class attributes:
        - graph (networkx.DiGraph): networkx graph representing
        the world map, with:
            Node properties:
