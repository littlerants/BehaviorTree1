...
if __name__ == "__main__":
    ...
    ego_vehicle = FakeCarlaActor(x=0, y=1, vx=0, vy=5, yaw=90)
    ego_vehicle.near_vehicles["P"] = FakeCarlaActor(x=0, y=15, vx=0, vy=6, yaw=90)
    ego_vehicle.near_vehicles["P_L"] = FakeCarlaActor(x=0, y=15, vx=0, vy=0, yaw=90)
    # ego_vehicle.near_vehicles["P_R"] = FakeCarlaActor(x=0, y=15, vx=0, vy=2, yaw=90)
    ego_vehicle.near_vehicles["F_L"] = FakeCarlaActor(x=0, y=-15, vx=0, vy=8, yaw=90)
    # ego_vehicle.near_vehicles["F_R"] = FakeCarlaActor(x=0, y=-15, vx=0, vy=3, yaw=90)
    print(f"{change_lane_policy(ego_vehicle)}\n")
