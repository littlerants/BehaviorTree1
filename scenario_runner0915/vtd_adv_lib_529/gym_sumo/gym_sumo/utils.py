...
def normalize_coordinate(array, max_coordinate, min_coordinate):
    array = (100. * (array.reshape(-1, 2)) / (max_coordinate - min_coordinate))
    return array


def rnormalize_coordinate(array, max_coordinate, min_coordinate):
    array = (array.reshape(-1, 2) * (max_coordinate - min_coordinate)) / 100.0
    return array
