...
from gym_sumo.road.lane import LineType, AbstractLane
from gym_sumo.road.road import Road
from gym_sumo.utils import Vector
from gym_sumo.vehicle.graphics import VehicleGraphics
from gym_sumo.vehicle.objects import Obstacle, Landmark

if TYPE_CHECKING:
    from gym_sumo.vehicle.objects import RoadObject
...
class LaneGraphics(object):
    ...
    def draw_stripes(cls, lane: AbstractLane, surface: WorldSurface,
        ...
        start_position = lane.position(0, 0)
        end_position = lane.position(lane.length-2, 0)
        font = pygame.font.Font(None, 12)
        text1 = "{}".format(lane.lane_index[0])
        text1 = font.render(text1, 1, (10, 10, 10), (255, 255, 255))
        text2 = "{}".format(lane.lane_index[1])
        text2 = font.render(text2, 1, (10, 10, 10), (255, 255, 255))
        surface.blit(text1, surface.vec2pix(start_position))
        surface.blit(text2, surface.vec2pix(end_position))
